module.exports = {
  sma: [
    ...
    { name: "Geografi", url: "/materi/sma/geografi/", icon: "fas fa-globe-asia", tag: "geografi" },
    { name: "Sejarah", url: "/materi/sma/sejarah/", icon: "fas fa-landmark", tag: "sejarah" },
    { name: "Ekonomi", url: "/materi/sma/ekonomi/", icon: "fas fa-coins", tag: "ekonomi" },
    { name: "Sosiologi", url: "/materi/sma/sosiologi/", icon: "fas fa-users", tag: "sosiologi" },
    { name: "Ujian Masuk PTN", url: "/materi/sma/ujianmasukptn/", icon: "fas fa-book-open", tag: "ujian-masuk-ptn"}
  ],
  smp: [
  ...
  edukasiWarga: [
    ...
    { name: "Peternakan & Perikanan", url: "/edukasi/peternakan/", icon: "fas fa-fish", tag: "peternakan" },
    { name: "UMKM & Pemasaran", url: "/edukasi/umkm/", icon: "fas fa-store", tag: "umkm" },
    { name: "Pengelolaan SDA", url: "/edukasi/sda/", icon: "fas fa-recycle", tag: "sda" },
    { name: "Literasi Digital", url: "/edukasi/digital/", icon: "fas fa-laptop-code", tag: "digital" },
    { name: "Kesehatan & Gizi", url: "/edukasi/kesehatan/", icon: "fas fa-heart-pulse", tag: "kesehatan" }
  ]
};